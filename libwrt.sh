...
# 只对dae设备应用BPF相关的内核配置
# 创建一个专门的内核配置文件用于dae设备
mkdir -p target/linux/qualcommax/ipq60xx/profiles
echo 'CONFIG_DEVEL=y
...
CONFIG_PACKAGE_kmod-sched-bpf=y' > target/linux/qualcommax/ipq60xx/profiles/dae.config
